...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: '#fdecea' },
  content: { width: '100%', maxWidth: 980, alignSelf: 'center', padding: 24, paddingBottom: 56 },
  header: { paddingVertical: 28, alignItems: 'center' },
  eyebrow: { color: '#c13a28', fontSize: 11, fontWeight: '800', letterSpacing: 2, marginBottom: 12 },
  title: { color: '#111827', fontSize: 42, fontWeight: '900', letterSpacing: 5 },
  subtitle: { color: '#c13a28', fontSize: 16, lineHeight: 24, textAlign: 'center', maxWidth: 560, marginTop: 12 },
  domainBadge: { marginTop: 18, backgroundColor: '#f0b5ab', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 8 },
  ...
  cardLabel: { color: '#c13a28', fontSize: 11, fontWeight: '800', letterSpacing: 1.4 },
  ...
  progressTrack: { height: 10, backgroundColor: '#c13a28', borderRadius: 5, overflow: 'hidden', marginTop: 14 },
  progressFill: { height: '100%', backgroundColor: '#4ade80', borderRadius: 5 },
  heroText: { color: '#f0b5ab', fontSize: 14, lineHeight: 22, marginTop: 16 },
  section: { marginBottom: 28 },
  sectionTitle: { color: '#111827', fontSize: 24, fontWeight: '800', marginBottom: 8 },
  sectionIntro: { color: '#c13a28', fontSize: 15, lineHeight: 22, marginBottom: 16 },
  featureGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  feature: { flexGrow: 1, flexBasis: '30%', minWidth: 220, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 12, padding: 15, borderWidth: 1, borderColor: '#f0b5ab' },
  featureMark: { color: '#16a34a', fontSize: 18, fontWeight: '900', marginRight: 10 },
  featureText: { color: '#334155', fontSize: 13, fontWeight: '700' },
  stageCard: { backgroundColor: '#fff', borderRadius: 14, padding: 17, marginTop: 10, borderWidth: 1, borderColor: '#f0b5ab' },
  ...
  stageTrack: { height: 7, backgroundColor: '#f0b5ab', borderRadius: 4, overflow: 'hidden', marginTop: 11 },
  ...
  stageDescription: { color: '#c13a28', fontSize: 12, flex: 1, lineHeight: 18 },
  paragraph: { color: '#c13a28', fontSize: 15, lineHeight: 24, marginTop: 8 },
  ...
  footerText: { color: '#c13a28', fontSize: 12, marginTop: 4, textAlign: 'center' },
